...
<body
	...
	<div class="loginbody">
		...
		<div class="loginbox">
			<form id="sysForm" action="${basePath}/login/confirmSys" method="post">
				<ul>
					<li><input name="username" type="text" class="loginuser"
						data-easytip="class:easy-blue;" /></li>
					<li><input name="passwd" type="password" class="loginpwd"
						data-easytip="class:easy-blue;" /></li>
					<li style="margin:0px;margin-left:20px;"><span style="color: red;">${requestScope.error}</span></li>
					<li><input id="confirm" type="button" class="loginbtn"
